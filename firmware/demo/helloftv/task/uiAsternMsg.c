...
///////////
	...
	drawLine(Ratex(x-3),Ratey(y),Ratex(x-3+20/RIGHT_RATE),Ratey(y+20),Ratew(5),R_COLOR_RED);
////////////////////////////////////////////////////////////////
	drawString(&rect,&rect,"STOP",R_FONT_NUM2,ALIGNMENT_CENTER,R_COLOR_YELLOW,INVALID_COLOR,INVALID_COLOR);
	return 0;
}
