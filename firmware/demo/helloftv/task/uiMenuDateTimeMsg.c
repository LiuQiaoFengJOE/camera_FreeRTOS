...
{
	if(num<6)
		uintToString(&dateTimeStr[num],DATE_TIME_STR_LEN,dateTimeData[num]);
}
...
msgDealInfor dateTimeMsgDeal[]=
{
	...
	{KEY_EVENT_LEFT,dateTimeKeyMsgMenu},
	{KEY_EVENT_RIGHT,dateTimeKeyMsgMode},
	{EVENT_MAX,NULL},
};
