...
static widgetCreateInfor menuItemWin[] =
{
	...
	//createStringIcon(ITEM_RESOLUTION_ID,Rx(132), Ry(0), Rw(40), Rh(25)," ",ALIGNMENT_CENTER, R_COLOR_WHITE,0),
...
static widgetCreateInfor menuItemWin[] =
{
	...
	//createStringIcon(ITEM_RESOLUTION_ID,Rx(100), Ry(0), Rw(30), Rh(25)," ",ALIGNMENT_CENTER, R_COLOR_WHITE,0),
...
static void menuResolutionShow(winHandle handle)
{
	/*if(configGet(CONFIG_ID_RESOLUTION)==R_ID_STR_RES_HD)
		...
		winSetResid(winItem(handle,ITEM_RESOLUTION_ID),strToResId("1080P"));
		...
		winSetResid(winItem(handle,ITEM_RESOLUTION_ID),strToResId("WVGA"));
