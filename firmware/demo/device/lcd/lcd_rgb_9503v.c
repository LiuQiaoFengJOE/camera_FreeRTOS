...
#if DEV_LCD  == DEV_LCD_9503V//DEV_LCD_ST7701SJL0439BOE
BEGIN_INIT_TAB
#if 1	
			...
			CMD(0xB0),
			  ...
			  CMD(0x3A),
			  DAT(0x50),	// 50 16BIT  60 18BIT 70 24BIT		
...
#if 0	///yuan
	////porch:
	///hsync8 hbp60 hadr480 hfp60
	///vsync8 vbp30 vadr640 vfp30
...
LCD_OP_SECTION lcddev_t ST7701SJL0439BOE = {
	...
	.lcd_data_mode = (0<<31)|//data inversion mode
				     (2<<24)|//data compress mode rgb565
				     (0<<20)|//fifo mode
...
//    .vsrc_h   = 240,
	.osd_x = 0,
	.osd_y = 0,//60,
	.osd_w = 0,//640,// 0 : value will set to video_w  , use for 4:3 LCD +16:9 sensor show UPDOWN BLACK
	.osd_h = 0,//420,// 0 : value will set to video_h  , use for 4:3 LCD +16:9 sensor show UPDOWN BLACK	
	.clk_per_pixel = 1,
