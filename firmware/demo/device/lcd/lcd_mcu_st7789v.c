...
LCD_OP_SECTION lcddev_t st7789v = 
{
	...
	.osd_x = 0,
	.osd_y = 0,
	.osd_w = 320,//0, // 0 : value will set to video_w  , use for 4:3 LCD +16:9 sensor show UPDOWN BLACK
	.osd_h = 240,//0, // 0 : value will set to video_h  , use for 4:3 LCD +16:9 sensor show UPDOWN BLACK
