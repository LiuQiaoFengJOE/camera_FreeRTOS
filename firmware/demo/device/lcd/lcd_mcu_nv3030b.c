...
CMD(0x2c), 
  ...
  CMD(0xe1),
  DAT(0x2f), //PRP0[6:0]
  DAT(0x72), //PRP1[6:0] //76  72
  CMD(0xe4),
  DAT(0x79), //PRN0[6:0] //75  79
  DAT(0x2f), //PRN1[6:0]
  CMD(0xe2),
  DAT(0x26), //VRP0[5:0]
  DAT(0x1f), //VRP1[5:0]
  ...
  //==========================================================
  CMD(0x2a),		  // column set
  DAT(0x00),		  //if MADCTL BIT5=0, EC[15:0]=0x00ef
  DAT(0x00),		  //if MADCTL BIT5=1, EC[15:0]=0x013f
  DAT(0x00),  //00
  DAT(0xEF),  //ef

  CMD(0x2B),		  // page address set
  DAT(0x00),		  //if MADCTL BIT5=0, EP[15:0]=0x013f
  DAT(0x00),		  //if MADCTL BIT5=1, EP[15:0]=0x00ef
  DAT(0x01),  //01
  DAT(0x3F),  //3f
...
LCD_OP_SECTION lcddev_t nv3030b = 
{
    ...
    .te_mode = 0x01,//te mode, 0xff:disable
    //.bus_cmd = 1,
	...
	.osd_x = 0,
	.osd_y = 0,
	.osd_w = 0,//320, // 0 : value will set to video_w  , use for 4:3 LCD +16:9 sensor show UPDOWN BLACK
	.osd_h = 0,//240, // 0 : value will set to video_h  , use for 4:3 LCD +16:9 sensor show UPDOWN BLACK
