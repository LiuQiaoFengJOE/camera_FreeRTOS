...
##
## Debug
ProjectName            :=_build-appoplat2-sdk
ConfigurationName      :=Debug
WorkspacePath          := "D:\Demo\Ax329x-wifi\Ax3292-DHZJ-E01\firmware\sdk\build"
ProjectPath            := "D:\Demo\Ax329x-wifi\Ax3292-DHZJ-E01\firmware\sdk\build"
...
ObjectsFileList        :="_build-appoplat2-sdk.txt"
PCHCompileFlags        :=
...
$(OutputFile): $(IntermediateDirectory)/.d ".build-debug\AX3292-bootfat32" ".build-debug\AX3292-lwip" ".build-debug\AX3292-mcu" ".build-debug\AX3292-os" ".build-debug\AX3292-sdrtune" ".build-debug\AX3292-unzip" ".build-debug\AX3292-lib20" ".build-debug\AX3292-libex" ".build-debug\AX3292-sys" $(Objects) 
	@$(MakeDirCommand) $(@D)
