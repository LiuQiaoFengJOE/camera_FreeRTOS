...
##
## Debug
ProjectName            :=_build-appoplat2-sdk-6158
ConfigurationName      :=Debug
WorkspacePath          := "E:\proj_code\WIFI_YG-K2T-TC\firmware\sdk\build"
ProjectPath            := "E:\proj_code\WIFI_YG-K2T-TC\firmware\sdk\build"
...
ObjectsFileList        :="_build-appoplat2-sdk-6158.txt"
PCHCompileFlags        :=
...
$(OutputFile): $(IntermediateDirectory)/.d ".build-debug\AX3292-bootfat32" ".build-debug\AX3292-mcu" ".build-debug\AX3292-os" ".build-debug\AX3292-sdrtune" ".build-debug\AX3292-unzip" ".build-debug\AX3292-ssv6158" ".build-debug\AX3292-lib14" ".build-debug\AX3292-libex" ".build-debug\AX3292-sys-sv6158" $(Objects) 
	@$(MakeDirCommand) $(@D)
...
".build-debug\AX3292-ssv6158":
	@$(MakeDirCommand) ".build-debug"
	@echo stam > ".build-debug\AX3292-ssv6158"


".build-debug\AX3292-lib14":
	@$(MakeDirCommand) ".build-debug"
	@echo stam > ".build-debug\AX3292-lib14"
...
".build-debug\AX3292-sys-sv6158":
	@$(MakeDirCommand) ".build-debug"
	@echo stam > ".build-debug\AX3292-sys-sv6158"
