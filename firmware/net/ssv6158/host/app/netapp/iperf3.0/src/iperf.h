...
struct iperf_settings
{
    ...
    ssv_type_u32       rate;                 /* target data rate */
...
struct iperf_stream
{
    ...
    ssv_type_u32       outoforder_packets;
    ssv_type_u32       cnt_error;
...
struct iperf_test
{
    ...
    /* ssv_type_boolean variables for Options */
    int       daemon;                           /* -D option */
    ...
    Timer     *free_timers;
    int       omitting;
    ssv_type_u32       stats_interval;
    ssv_type_u32       reporter_interval;
