...
#define Psctp 12
#define DEFAULT_UDP_BLKSIZE 1472  //8192
#define DEFAULT_TCP_BLKSIZE (4*1024) //(128 * 1024)  /* default read/write block size */
#define DEFAULT_SCTP_BLKSIZE (64 * 1024)

#define DEFAULT_MULTI_SEND  10
...
void iperf_set_state (struct iperf_test* ipt, signed char state);
...
enum {
    ...
    IEBANDWIDTH = 21,       // bandwidth too large. 
    /* Test errors */
    ...
    IEV4ONLY = 140,         // SUPPORT IPv4 only
    /* Stream errors */
