...
#define REG_SDIO_CMD_DELAY	    (BASE_SDIO + 0x58)		// 0
#define REG_SDIO_DAT3_DELAY	    (BASE_SDIO + 0x59)		// 0
#define REG_SDIO_DAT2_DELAY	    (BASE_SDIO + 0x5A)		// 0
#define REG_SDIO_DAT1_DELAY	    (BASE_SDIO + 0x5B)		// 0
#define REG_SDIO_DAT0_DELAY	    (BASE_SDIO + 0x5C)		// 0
...
#define SDIO_BUS_1_BIT 1
#define SDIO_BUS_4_BIT 2
