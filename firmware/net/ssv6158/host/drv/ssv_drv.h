...
ssv_type_bool ssv6xxx_drv_select(char name[32], ssv_type_bool bAlreadyInit);
...
ssv_type_s32 ssv6xxx_drv_suspend(int inband_wakeup);
ssv_type_s32 ssv6xxx_drv_resume(int inband_wakeup);
ssv_type_bool ssv6xxx_drv_tx_resource_enough(ssv_type_u32 frame_len);
ssv_type_bool ssv6xxx_drv_update_tx_resource(void);
ssv_type_bool ssv6xxx_drv_check_tx_resource(ssv_type_u32 frame_len);
