...
#define LWIP_SENDTO_AUTORETRY_TIMES	   100//5 // 0 is not retry, 
...
|PBUF STRUCT|TX INFO SIZE(80Byts)|802.11 header(24BYTES)|QOS(2Bytes)|LLC(6Bytes)|TYPE(2BYTES)|IP Header|TCP Header|TCP Payload|
                                 |<-    20Bytes->|
*/
#define DRV_TRX_HDR_LEN					(80+20)//length should be divide by 4
#else
...
#elif (LWIP_PARAM_SET == 4)
#define MEMP_NUM_TCP_SEG		216
#endif
...
#define MEMP_NUM_TCP_PCB  58

/* MEMP_NUM_NETCONN: the number of struct netconns. */
//!!!! warning: system must be FD_SETSIZE = 64
#define MEMP_NUM_NETCONN        64 //14
...
#elif (LWIP_PARAM_SET == 2)
#define PBUF_POOL_SIZE			66
#elif (LWIP_PARAM_SET == 3)
#define PBUF_POOL_SIZE			160//106
#elif (LWIP_PARAM_SET == 4)
#define PBUF_POOL_SIZE			272
#endif
...
#if(SW_8023TO80211==1)
#define PBUF_POOL_BUFSIZE		LWIP_MEM_ALIGN_SIZE(TCP_MSS+20+20+PBUF_LINK_HLEN+DRV_TRX_HDR_LEN+STRUCT_PBUF_LEN)  //PBUF_TRANSPORT_HLEN = 20, PBUF_IP_HLEN = 20
#define MAX_RECV_BUF	                           (TCP_MSS+20+20+PBUF_LINK_HLEN+DRV_TRX_HDR_LEN)
#else
...
#define DEFAULT_UDP_RECVMBOX_SIZE       PBUF_POOL_SIZE
...
#define TCP_WND_UPDATE_THRESHOLD   (TCP_MSS * 2)
#elif (LWIP_PARAM_SET == 4)
#define TCP_SND_BUF				( TCP_MSS * 36 )
#define TCP_SND_QUEUELEN		(2 * TCP_SND_BUF/TCP_MSS)
#define TCP_WND					(TCP_MSS * 36)
#define TCP_WND_UPDATE_THRESHOLD   (TCP_MSS * 2)
#endif
...
#if defined(HTTPD_SUPPORT) && (HTTPD_SUPPORT == 1)
