...
struct ssv6xxx_drv_ops
{
	...
	ssv_type_u32    (*write_fw_to_sram)(ssv_type_u8 *fw_bin, ssv_type_u32 fw_bin_len, ssv_type_u32 sram_addr, ssv_type_bool need_checksum, ssv_type_u32 block_size);
    ...
    ssv_type_s32    (*suspend)(int inband_wakeup);
    ssv_type_s32    (*resume)(int inband_wakeup);
};
	...
	extern const struct ssv6xxx_drv_ops	g_drv_usb;
#endif
