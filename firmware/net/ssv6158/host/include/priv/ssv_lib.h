...
LIB_APIs char *ssv6xxx_strdup(const char *s);
LIB_APIs int ssv6xxx_snprintf(char *str, size_t size, const char *format, ...);
...
LIB_APIs void ssv6xxx_raw_dump(ssv_type_u8 *data, ssv_type_s32 len);


void packetdump(const char *title, const ssv_type_u8 *buf,
                             ssv_type_size_t len);
