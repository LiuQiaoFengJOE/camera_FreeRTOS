...
#define CURRENT_CHANNEL(VIF) (gDeviceInfo->vif[VIF].freq.current_channel)
#define CURRENT_CHANNEL_BW(VIF) (gDeviceInfo->vif[VIF].freq.sec_channel_offset)
...
struct SSV_PACKED_STRUCT ssv6xxx_ieee80211_bss {
	...
	ssv_type_u8 short_preamble;
	ssv_type_u8 short_slot_time;
