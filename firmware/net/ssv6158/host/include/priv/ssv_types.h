...
typedef unsigned char ssv_type_bool ;
typedef unsigned char ssv_type_u8 ;
typedef unsigned short ssv_type_u16 ;
typedef unsigned int ssv_type_u32 ;
typedef unsigned long long  ssv_type_u64;

typedef signed char ssv_type_s8;
typedef signed short ssv_type_s16 ;
typedef signed int   ssv_type_s32;
typedef signed long long ssv_type_s64;
...
#define _LE16(x)                        ((ssv_type_u16)(x))
#define _BE16(x)                        ((ssv_type_u16) ((((x)&0xFF) << 8) | (((x)&0xFF00)>>8)))
#endif /* _SSV_TYPES_H_ */
