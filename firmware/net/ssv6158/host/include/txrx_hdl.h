...
ssv_type_bool TxHdl_FrameProc(void *frame, ssv_type_bool bMlmeFrame, ssv_type_u32 priority, ssv_type_u32 flags, ssv_vif* vif);
...
void ieee80211_addba_handler(ssv_type_u8 wsid, ssv_type_u8 tid, ssv_type_u16 ssn, 
	ssv_type_u16 buf_size, ssv_type_u8 bssid_idx);
#endif //_TXRX_HDL_H
