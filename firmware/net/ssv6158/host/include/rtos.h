...
#define OS_ELOOP_TASK_PRIO              ELOOP_TASK_PRIORITY
#define OS_TMR_TASK_PRIO                TMR_TASK_PRIORITY
#define OS_STA_SCAN_TASK_PRIO           MLME_TASK_PRIORITY  
#define OS_RX_ISR_PRIO                  RX_ISR_PRIORITY
#define OS_SCONFIG_TASK_PRIO            SCONFIG_PRIORITY
...
#define OS_MS2TICK(_ms)         ( (_ms + TICK_RATE_MS - 1)/TICK_RATE_MS )
...
typedef struct task_info_st 
{
    ...
    OsMsgQ      qevt;
    ssv_type_u16          qlength;
    ssv_type_u16          prio;
    ssv_type_u32          stack_size;  /* unit: 16 */
    void        *args;
    TASK_FUNC   task_func; 
...
OS_APIs ssv_type_s32 OS_SemWait( OsSemaphore Sem , ssv_type_u16 timeout);
