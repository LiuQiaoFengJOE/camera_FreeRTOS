...
typedef struct atbm_etf_request{
	atbm_uint32 version;
	atbm_uint32 channel_type;
	atbm_uint32 channel;
	atbm_uint32 rate;
	atbm_uint32 len;	
	atbm_uint32 greedfiled;
	atbm_uint32 precomp_sel;	
}etf_req_t;
int atbm_etf_start_rx_cert(etf_req_t *rx_param);
int atbm_etf_start_tx_cert(etf_req_t *tx_param);
...
int atbm_etf_get_rx_statistic(atbm_uint32 *rxSuc,atbm_uint32 *rxErr);
