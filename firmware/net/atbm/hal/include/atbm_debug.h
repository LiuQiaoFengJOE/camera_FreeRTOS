...
#define ATBM_ERR_PRINTF(enable, tagged, ...)						\
				do{ 								\
					if( enable){							\
						if( tagged){ 					\
...
#define ATBM_ERROR(...)	ATBM_ERR_PRINTF(1, 1, "ERROR:"__VA_ARGS__)
...
#define WIFI_BASETUP	BIT(24)
#define WIFI_BLE		BIT(25)
...
//#define wifi_printk(_level,...) do {iot_printf(__VA_ARGS__);} while (0)
