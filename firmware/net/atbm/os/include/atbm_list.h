 ...
 */
static  atbm_void atbm___list_add(struct atbm_list_head *new,
 ...
 */
static  atbm_void atbm_list_add(struct atbm_list_head *new, struct atbm_list_head *head)
{
 ...
 */
static  atbm_void atbm_list_add_tail(struct atbm_list_head *new, struct atbm_list_head *head)
{
 ...
 * the prev/next entries already!
 */
static  atbm_void atbm___list_del(struct atbm_list_head * prev, struct atbm_list_head * next)
{
	next->prev = prev;
	prev->next = next;
}
 ...
 */
static  atbm_void atbm_list_del(struct atbm_list_head *entry)
{
 ...
 * @entry: the element to delete from the list.
 */
static  atbm_void atbm_list_del_init(struct atbm_list_head *entry) {
 ...
 */
static  atbm_void atbm_list_move(struct atbm_list_head *list, struct atbm_list_head *head) {
 ...
 */
static  atbm_void atbm_list_move_tail(struct atbm_list_head *list, struct atbm_list_head *head) {
 ...
 */
static  int atbm_list_empty(const struct atbm_list_head *head)
{
 ...
 * @head: the list to test.
 */
static  int atbm_list_empty_careful(const struct atbm_list_head *head)
{
	struct atbm_list_head *next = head->next;
	return (next == head) && (next == head->prev);
}

static  atbm_void __atbm_list_splice(struct atbm_list_head *list,
 ...
 */
static  atbm_void atbm_list_splice(struct atbm_list_head *list, struct atbm_list_head *head)
{
 ...
 */
static  atbm_void atbm_list_splice_init(struct atbm_list_head *list,
				    struct atbm_list_head *head)
{
	if (!atbm_list_empty(list)) {
		__atbm_list_splice(list, head);
...
static  int atbm_list_swap(struct atbm_list_head *a, struct atbm_list_head *b, struct atbm_list_head *list)
{
...
static  atbm_void atbm_list_splice_tail_init(struct atbm_list_head *list,struct atbm_list_head *head)
{
	if(!atbm_list_empty(list)){
