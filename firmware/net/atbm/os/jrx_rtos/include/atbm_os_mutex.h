...
#include "atbm_type.h"
#include "os/freeRTOS/api/inc/api.h"
...
/*sem*/
//#define	atbm_os_DeleteSem   atbm_os_delete_waitevent
...
atbm_uint8 atbm_os_delete_waitevent(atbm_os_wait_queue_head_t* pulSem);
