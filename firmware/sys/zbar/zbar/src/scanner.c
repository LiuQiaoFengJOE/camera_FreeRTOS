...
inline zbar_symbol_type_t zbar_scanner_new_scan (zbar_scanner_t *scn)
{
...
inline zbar_symbol_type_t zbar_scan_y (zbar_scanner_t *scn,
                                int y)
{
...
//    register int y2_2 = y0_1 - (y0_2 * 2) + y0_3;
    register int y2_1 = y0_0 - (y0_1<<1) + y0_2;
    register int y2_2 = y0_1 - (y0_2<<1) + y0_3;
