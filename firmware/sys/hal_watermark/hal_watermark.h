...
#define TIME0_FONT_W 0x10 // 32
#define TIME0_FONT_H 0x20 // 32
...
void hal_watermarkSetPos(u16 mode, u16 x, u16 y);//mode?a1¡§o?¨¤?¨º? x?¨¤¡§a¡§o???¡§??|¨¬??¨¢¡§??¨¤????¡§¡è¡§¡è??¨º? Y?¨¤¡§a¡§o???¡§??|¨¬?|¨¬?¨¢??|¨¬??¡§¡è¡§¡è??¨º? mode?a0¡§o?¨¤, hal_watermarkSetPos¡§|¡§¡§??|¨¬??¨¢??¨¤¡§o?TD?¨¬?¨º? ¡§o1¡§????¡§¡§??¨¢??¨¤¡§o
