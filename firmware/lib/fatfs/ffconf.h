...
/---------------------------------------------------------------------------*/
#define FF_FS_FAT_COPY   1 /*number of FATs */
...
#define FF_FASTSEEK_BLK_SIZE   1024
...
#define FF_UNLINK_EXT        0   // 0-disable,1-enable

#define FF_LINK_EXT           1   //0-disable,1-enable
