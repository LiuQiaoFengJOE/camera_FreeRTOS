...
.NOC_BACK_CODEC_RD_QOS_STEP      = 0,
.NOC_BACK_CODEC_RD_LATENCY       = 0,
.NOC_BACK_CODEC_WR2LCD_QOS_STEP  = 1,
.NOC_BACK_CODEC_WR2LCD_LATENCY   = 0,
...
u32  NOC_ISP_WR2LCD_LATENCY;
////ISP read dram
u32  NOC_ISP_RDDRAM_QOS_STEP;
u32  NOC_ISP_RDDRAM_LATENCY;
////DCACHE
u32  NOC_DCACHE_QOS_STEP;
u32  NOC_DCACHE_LATENCY;
////ICACHE
...
u32  NOC_ICACHE_LATENCY;
////OSDCMP READ
u32  NOC_OSDCMP_RD_QOS_STEP;
u32  NOC_OSDCMP_RD_LATENCY;
////OSDCMP WRITE
u32  NOC_OSDCMP_WR_QOS_STEP;
u32  NOC_OSDCMP_WR_LATENCY;
////ROTATE READ
...
.NOC_BACK_CODEC_RD_QOS_STEP      = 3,
.NOC_BACK_CODEC_RD_LATENCY       = 3000,
.NOC_BACK_CODEC_WR2LCD_QOS_STEP  = 3,
.NOC_BACK_CODEC_WR2LCD_LATENCY   = 1000,
.NOC_PRE_CODEC_WR2CARD_QOS_STEP  = 3,
.NOC_PRE_CODEC_WR2CARD_LATENCY   = 1000,
.NOC_PRE_CODEC_RD_QOS_STEP       = 2,
.NOC_PRE_CODEC_RD_LATENCY        = 1000,
.NOC_ISP_WR2CARD_QOS_STEP        = 1,
.NOC_ISP_WR2CARD_LATENCY         = 8000,
.NOC_ISP_WR2WIFI_QOS_STEP        = 1,
.NOC_ISP_WR2WIFI_LATENCY         = 5000,
.NOC_ISP_WR2LCD_QOS_STEP         = 1,
.NOC_ISP_WR2LCD_LATENCY          = 6500,
.NOC_DCACHE_QOS_STEP             = 1,
.NOC_DCACHE_LATENCY              = 0,
.NOC_ICACHE_QOS_STEP             = 1,
.NOC_ICACHE_LATENCY              = 0,
.NOC_OSDCMP_RD_QOS_STEP          = 3,
.NOC_OSDCMP_RD_LATENCY           = 1000,
.NOC_OSDCMP_WR_QOS_STEP          = 3,
.NOC_OSDCMP_WR_LATENCY           = 1000,
.NOC_ROTATE_RD_QOS_STEP          = 3,
.NOC_ROTATE_RD_LATENCY           = 3000,
.NOC_ROTATE_WR_QOS_STEP          = 3,
.NOC_ROTATE_WR_LATENCY           = 3000,
.NOC_ISP_RD_DRAM_QOS_STEP        = 2,
.NOC_ISP_RD_DRAM_LATENCY         = 2000,
#else
.NOC_SDC0_QOS_STEP               = 2,
.NOC_SDC0_LATENCY                = 0,
.NOC_DE_QOS_STEP                 = 3,
.NOC_DE_LATENCY                  = 2500,
.NOC_BACK_CODEC_WR2CARD_QOS_STEP = 2,
.NOC_BACK_CODEC_WR2CARD_LATENCY  = 500,
.NOC_BACK_CODEC_RD_QOS_STEP      = 3,
.NOC_BACK_CODEC_RD_LATENCY       = 5000,
.NOC_BACK_CODEC_WR2LCD_QOS_STEP  = 2,
.NOC_BACK_CODEC_WR2LCD_LATENCY   = 5000,
.NOC_PRE_CODEC_WR2CARD_QOS_STEP  = 3,
.NOC_PRE_CODEC_WR2CARD_LATENCY   = 1500,
.NOC_PRE_CODEC_RD_QOS_STEP       = 2,
.NOC_PRE_CODEC_RD_LATENCY        = 1500,
.NOC_ISP_WR2CARD_QOS_STEP        = 1,
.NOC_ISP_WR2CARD_LATENCY         = 6000,
.NOC_ISP_WR2WIFI_QOS_STEP        = 2,
.NOC_ISP_WR2WIFI_LATENCY         = 000,
.NOC_ISP_WR2LCD_QOS_STEP         = 1,
.NOC_ISP_WR2LCD_LATENCY          = 7500,
.NOC_DCACHE_QOS_STEP             = 1,
.NOC_DCACHE_LATENCY              = 0,
.NOC_ICACHE_QOS_STEP             = 1,
.NOC_ICACHE_LATENCY              = 0,
.NOC_OSDCMP_RD_QOS_STEP          = 3,
.NOC_OSDCMP_RD_LATENCY           = 4000,
.NOC_OSDCMP_WR_QOS_STEP          = 3,
.NOC_OSDCMP_WR_LATENCY           = 4000,
.NOC_ROTATE_RD_QOS_STEP          = 3,
.NOC_ROTATE_RD_LATENCY           = 3000,
.NOC_ROTATE_WR_QOS_STEP          = 3,
.NOC_ROTATE_WR_LATENCY           = 3000,
.NOC_ISP_RD_DRAM_QOS_STEP        = 2,
.NOC_ISP_RD_DRAM_LATENCY         = 5000,
#endif
};
void ax32xx_dmaNocCfg(noc_cfg_t * p_cfg)
{
...
u32  NOC_ICACHE_LATENCY  = p_cfg->NOC_ICACHE_LATENCY;
////OSDCMP READ
u32  NOC_OSDCMP_RD_QOS_STEP = p_cfg->NOC_OSDCMP_RD_QOS_STEP;
u32  NOC_OSDCMP_RD_LATENCY  = p_cfg->NOC_OSDCMP_RD_LATENCY;
////OSDCMP WRITE
u32  NOC_OSDCMP_WR_QOS_STEP = p_cfg->NOC_OSDCMP_WR_QOS_STEP;
u32  NOC_OSDCMP_WR_LATENCY  = p_cfg->NOC_OSDCMP_WR_LATENCY;
////ROTATE READ
u32  NOC_ROTATE_RD_QOS_STEP = p_cfg->NOC_ROTATE_RD_QOS_STEP;
u32  NOC_ROTATE_RD_LATENCY = p_cfg->NOC_ROTATE_RD_LATENCY;
////ROTATE WRITE
u32  NOC_ROTATE_WR_QOS_STEP = p_cfg->NOC_ROTATE_WR_QOS_STEP;
u32  NOC_ROTATE_WR_LATENCY  = p_cfg->NOC_ROTATE_WR_LATENCY;
////ISP_RD_DRAM
u32  NOC_ISP_RD_DRAM_QOS_STEP = p_cfg->NOC_ISP_RD_DRAM_QOS_STEP;
u32  NOC_ISP_RD_DRAM_LATENCY  = p_cfg->NOC_ISP_RD_DRAM_LATENCY;
...
//channel 18
u32  CH18_QOS_MAX = 0x1F & 18 ;
u32  CH18_QOS_MIN = 0x1F & (CH18_QOS_MAX-NOC_ISP_RD_DRAM_QOS_STEP+1);
u32  CH18_LATENCY = NOC_ISP_RD_DRAM_LATENCY & 0xFFFF;
NOC_REG15  = (CH18_LATENCY<<16) |
             (CH18_QOS_MAX<<8) |
             (CH18_QOS_MIN<<3) | 1;
//channel 19
u32  CH19_QOS_MAX = 0x1F & 19 ;
...
NOC_REG24  = (CH27_LATENCY<<16) |
             ...
             (CH27_QOS_MIN<<3) | 1;
//channel 28
u32  CH28_QOS_MAX = 0x1F & 28 ;
u32  CH28_QOS_MIN = 0x1F & (CH28_QOS_MAX-NOC_OSDCMP_WR_QOS_STEP+1);
u32  CH28_LATENCY = NOC_OSDCMP_WR_LATENCY & 0xFFFF;
NOC_REG25  = (CH28_LATENCY<<16) |
             (CH28_QOS_MAX<<8) |
             (CH28_QOS_MIN<<3) | 1;
//channel 29
u32  CH29_QOS_MAX = 0x1F & 29 ;
u32  CH29_QOS_MIN = 0x1F & (CH29_QOS_MAX-NOC_OSDCMP_RD_QOS_STEP+1);
u32  CH29_LATENCY = NOC_OSDCMP_RD_LATENCY & 0xFFFF;
NOC_REG26  = (CH29_LATENCY<<16) |
             (CH29_QOS_MAX<<8) |
             (CH29_QOS_MIN<<3) | 1;

//channel 30
u32  CH30_QOS_MAX = 0x1F & 30 ;
u32  CH30_QOS_MIN = 0x1F & (CH30_QOS_MAX-NOC_ROTATE_WR_QOS_STEP+1);
u32  CH30_LATENCY = NOC_ROTATE_WR_LATENCY & 0xFFFF;
NOC_REG27  = (CH30_LATENCY<<16) |
             (CH30_QOS_MAX<<8) |
             (CH30_QOS_MIN<<3) | 1;

//channel 31
u32  CH31_QOS_MAX = 0x1F & 31 ;
u32  CH31_QOS_MIN = 0x1F & (CH31_QOS_MAX-NOC_ROTATE_RD_QOS_STEP+1);
u32  CH31_LATENCY = NOC_ROTATE_RD_LATENCY & 0xFFFF;
NOC_REG28  = (CH31_LATENCY<<16) |
             (CH31_QOS_MAX<<8) |
             (CH31_QOS_MIN<<3) | 1;
}
