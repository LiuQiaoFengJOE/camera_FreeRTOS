...
void ax32xx_mjpegATimeinfoSize(u8 layer, u32 width, u32 height)
{
	...
	switch (layer)
	{
	case MJPEG_TIMEINFO_LAYER0:
		R_MJPEGA_TIMEINFO_SIZE0 = (width << 16) | height;
		break;
	case MJPEG_TIMEINFO_LAYER1:
		R_MJPEGA_TIMEINFO_SIZE1 = (width << 16) | height;
		break;
	case MJPEG_TIMEINFO_LAYER2:
		R_MJPEGA_TIMEINFO_SIZE2 = (width << 16) | height;
		break;
	}
}
void ax32xx_mjpegBTimeinfoSize(u8 layer, u32 width, u32 height)
{
	...
	{
	case MJPEG_TIMEINFO_LAYER0:
		R_MJPEGB_TIMEINFO_SIZE0 = (width << 16) | height;
		break;
	case MJPEG_TIMEINFO_LAYER1:
		R_MJPEGB_TIMEINFO_SIZE1 = (width << 16) | height;
		break;
	case MJPEG_TIMEINFO_LAYER2:
		R_MJPEGB_TIMEINFO_SIZE2 = (width << 16) | height;
		break;
	}
...
void ax32xx_mjpegATimeinfoPos(u8 layer, s32 x, s32 y)
{
	...
	{
	case MJPEG_TIMEINFO_LAYER0:
		R_MJPEGA_TIMEINFO_POS0 = (x << 16) | y;
		break;
	case MJPEG_TIMEINFO_LAYER1:
		R_MJPEGA_TIMEINFO_POS1 = (x << 16) | y;
		break;
	case MJPEG_TIMEINFO_LAYER2:
		R_MJPEGA_TIMEINFO_POS2 = (x << 16) | y;
		break;
	}
}
void ax32xx_mjpegBTimeinfoPos(u8 layer, s32 x, s32 y)
{
	...
	{
	case MJPEG_TIMEINFO_LAYER0:
		R_MJPEGB_TIMEINFO_POS0 = (x << 16) | y;
		break;
	case MJPEG_TIMEINFO_LAYER1:
		R_MJPEGB_TIMEINFO_POS1 = (x << 16) | y;
		break;
	case MJPEG_TIMEINFO_LAYER2:
		R_MJPEGB_TIMEINFO_POS2 = (x << 16) | y;
		break;
	}
...
void ax32xx_mjpegATimeinfoAddr(u8 layer, u32 addr)
{
	...
	{
	case MJPEG_TIMEINFO_LAYER0:
		R_MJPEGA_TIMEINFO_ADDR0 = addr;
		break;
	case MJPEG_TIMEINFO_LAYER1:
		R_MJPEGA_TIMEINFO_ADDR1 = addr;
		break;
	case MJPEG_TIMEINFO_LAYER2:
		R_MJPEGA_TIMEINFO_ADDR2 = addr;
		break;
	}
}
void ax32xx_mjpegBTimeinfoAddr(u8 layer, u32 addr)
{
	...
	{
	case MJPEG_TIMEINFO_LAYER0:
		R_MJPEGB_TIMEINFO_ADDR0 = addr;
		break;
	case MJPEG_TIMEINFO_LAYER1:
		R_MJPEGB_TIMEINFO_ADDR1 = addr;
		break;
	case MJPEG_TIMEINFO_LAYER2:
		R_MJPEGB_TIMEINFO_ADDR2 = addr;
		break;
	}
