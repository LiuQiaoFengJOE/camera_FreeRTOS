...
#include "typedef.h"
//#include "ax3281_mjpeg/mjpeg_driver.h"
// #include "csi/csi.h"
...
/*mjpeg irq statu*/
#define MJPEG_OUT_PACK_FULL BIT(1)
#define MJPEG_DATA_ERR BIT(2)
#define MJPEG_IN_PACK_FULL BIT(3)
#define MJPEG_FRAME_DONE BIT(4)
 ...
 * Return         : none
 *******************************************************************************/
void ax32xx_mjpegIRQHandler(void);
/*******************************************************************************
