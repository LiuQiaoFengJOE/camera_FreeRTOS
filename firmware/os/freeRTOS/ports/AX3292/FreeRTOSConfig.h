...
#define MY_PREEMPTION 0
#elif WIFI_SUPPORT_VERSION == BOARD_WIFI_RTL8189FTV
#define MY_PREEMPTION 1
#else
#define MY_PREEMPTION 0
#endif

#define configUSE_PREEMPTION MY_PREEMPTION // 6030 = 0
#define configUSE_IDLE_HOOK 1
#define configUSE_TICK_HOOK 1
#define configCPU_CLOCK_HZ ((unsigned long)54000000)
#define configTICK_RATE_HZ ((portTickType)1000)
#define configMAX_PRIORITIES ((unsigned portBASE_TYPE)32)
#define configMINIMAL_STACK_SIZE ((unsigned short)512) //( ( unsigned short ) 4*1024 )

#define configAPPLICATION_ALLOCATED_HEAP 1
#if (configAPPLICATION_ALLOCATED_HEAP == 1)
/* The modified heap_4.c need configTOTAL_HEAP_SIZE defined by ld-script */
#elif defined(CONFIG_SMALL_HEAP)
...
#define configTIMER_QUEUE_LENGTH 150 * 2
